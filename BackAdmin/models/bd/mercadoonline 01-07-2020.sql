...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2020 a las 06:04:37
...
(1, 'admin@gmail.com', '1234', 'jader', 'golindano', 0, 0, 0, '2020-07-02 02:56:36');
...
(73, 'usuario@gmail.com', '$2a$07$asxx54ahjppf45sd87a5aupT48FB4s1ygPNZ5fPuasNsxRQmWfcGK', 0, 0, 0, 1, '2020-07-01 04:38:17'),
(75, 'zero1990@gmail.com', '$2a$07$asxx54ahjppf45sd87a5aup1bxOj44/.I/OhL4Cdd4EvGQ8zue1m.', 0, 0, 0, 1, '2020-07-01 03:18:25');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `validacionusuarios`
--
...
--
-- Indices de la tabla `validacionusuarios`
--
...
--
-- AUTO_INCREMENT de la tabla `validacionusuarios`
--
ALTER TABLE `validacionusuarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
