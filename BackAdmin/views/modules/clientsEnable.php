...
<!-- Lash -->
	<ul class="nav nav-pills col-lg-6 col-md-6 col-sm-6 col-xs-6">
		...
		<li class="nav-item">
			<a class="nav-link"  href="index.php?action=clients">Clientes</a>
		</li>

		<li class="nav-item">
			<a class="nav-link active"  href="index.php?action=clientsEnable">Clientes Bloqueados</a>
		</li>
 	...
 	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 		...
 		<table class="table table-striped table-sm" id="clientTable" style="font-family: Pavanam-Regular; ">
  		...
  		<?php 
 			...
 			$viewClientData -> viewClientEnableController();
